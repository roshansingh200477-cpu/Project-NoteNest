...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_UR}/api/auth/createuser`, {
        method: "POST",
  ...
  return (
    <>
      <style>{`
        ...
        .login-link a:hover { color: #b45309; }
      ...
      <div className="signup-root">
        ...
        <div className="signup-card">
          ...
          <div className="signup-brand">
            ...
            <span className="signup-brand-name">NoteNest</span>
          </div>
          <p className="signup-subtitle">Your second brain, simplified.</p>

          <div className="badge-row">
            <span className="signup-badge">✨ Create your free account</span>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <label className="creamy-label"><span>👤</span> Full Name</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label className="creamy-label"><span>🔑</span> Confirm Password</label>
              <input
                type="password"
                className="creamy-input"
                id="cpassword"
